...
export default function PrinterList() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12" style={{ backgroundColor: '#EB3C7D' }}>
      <div className="bg-white border border-primary rounded-2xl p-8 w-full max-w-4xl font-sans shadow-lg">

        <h1 className="text-4xl font-extrabold mb-4 text-primary text-center">
          CentralPrint
        </h1>
        <p className="text-2xl font-bold mb-8 text-primary text-center">
        ...
        {syncStats && (
          <section
            style={{ backgroundColor: '#FF96B2' }}
            className="mb-10 p-6 border border-primary rounded-lg text-primary-dark"
          >
        ...
        <ul className="space-y-4">
          {printers.map((p) => (
            <li
              key={p.id}
              className="border border-primary rounded-lg p-4 flex justify-between items-center hover:shadow-lg transition-shadow duration-300"
            >
              <div>
        ...
        <div className="flex items-center justify-center gap-6 mt-10">
          <button
            ...
            disabled={page === 0}
            className={`px-4 py-2 rounded font-semibold border border-primary text-secondary ${
          ...
          <span className="font-medium text-lg">
            Página <span className="text-accent font-bold">{page + 1}</span> de{' '}
            <span className="text-secondary font-bold">{totalPages}</span>
          </span>
